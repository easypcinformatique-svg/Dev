...
export const PHASES = [
  {
    ...
    color: '#dc2626',
    tasks: [
      { id: 'p0t1', label: 'Souscrire Assurance Dommages-Ouvrage (DO)', deadline: '2026-04-18', legal: true, critical: true, note: 'Obligatoire AVANT ouverture chantier — Loi Spinetta art. L242-1. Contacter courtier BTP spécialisé.', help: 'L\'assurance DO vous protège contre les malfaçons pendant 10 ans. Elle est obligatoire pour toute construction neuve. Passez par un courtier spécialisé BTP pour des tarifs compétitifs.', links: [{ label: 'Infos DO', url: 'https://www.service-public.fr/particuliers/vosdroits/F2032' }] },
      { id: 'p0t2', label: 'Demander attestation décennale à ELCR', deadline: '2026-04-18', critical: true, note: 'Nécessaire pour le dossier DO et avant signature contrat.', help: 'Demandez à ELCR leur attestation d\'assurance RC décennale en cours de validité. Vérifiez que les activités couvertes correspondent à vos travaux.' },
      { id: 'p0t3', label: 'DT — Déclaration de Travaux réseaux enterrés', deadline: '2026-04-14', legal: true, critical: true, note: 'Cerfa 14434*03 — Délai 20 jours avant travaux.', help: 'La DT permet de localiser les réseaux enterrés (gaz, eau, électricité, télécoms) avant de creuser. À déposer sur le guichet unique.', links: [{ label: 'Cerfa 14434*03', url: 'https://www.service-public.fr/professionnels-entreprises/vosdroits/R33264' }, { label: 'Guichet unique réseaux', url: 'https://www.reseaux-et-canalisations.ineris.fr/gu-presentation/construire-sans-detruire' }] },
  ...
  },
  {
    ...
    color: '#ea580c',
    tasks: [
      { id: 'p1t1', label: 'DICT par ELCR (Cerfa 14434*03)', deadline: '2026-04-20', legal: true, note: 'Déclaration Intention Commencement Travaux — à faire par l\'artisan.', links: [{ label: 'Cerfa 14434*03', url: 'https://www.service-public.fr/professionnels-entreprises/vosdroits/R33264' }] },
      ...
      { id: 'p1t5', label: 'DOC — Déclaration Ouverture de Chantier (Cerfa 13407)', deadline: '2026-04-28', legal: true, critical: true, note: 'À déposer en mairie Les Pennes Mirabeau — J0 ou J-2.', links: [{ label: 'Cerfa 13407 (DOC)', url: 'https://www.service-public.fr/particuliers/vosdroits/R1978' }, { label: 'Remplir en ligne', url: 'https://psl.service-public.fr/mademarche/DOCTRAVam/demarche' }] },
  ...
  },
  {
    ...
    color: '#2563eb',
    tasks: [
      { id: 'p7t1', label: 'Test perméabilité à l\'air RE2020 (≤ 0.60 m³/h/m²)', deadline: '2027-08-01', legal: true, note: 'Opérateur Qualibat 8711 — coût 250-400€.', links: [{ label: 'RE2020 expliquée', url: 'https://www.ecologie.gouv.fr/politiques-publiques/reglementation-environnementale-re2020' }] },
      ...
      { id: 'p7t4', label: 'Consuel — attestation conformité électrique', deadline: '2027-08-15', legal: true, note: 'Cerfa 12506*03 (attestation jaune) — coût 120-200€. Sans elle, pas de raccordement ENEDIS.', links: [{ label: 'Demande Consuel', url: 'https://www.consuel.com/demander-mon-attestation/' }] },
  ...
  },
  {
    ...
    color: '#7c3aed',
    tasks: [
      { id: 'p8t1', label: 'DAACT en mairie (Cerfa 13408)', deadline: '2027-10-15', legal: true, critical: true, note: 'Dans les 30 jours après achèvement + joindre attestation RE2020 n°2.', links: [{ label: 'Cerfa 13408 (DAACT)', url: 'https://www.service-public.fr/particuliers/vosdroits/R1976' }] },
      { id: 'p8t2', label: 'Déclaration H1 aux impôts (Cerfa 10867)', deadline: '2027-12-15', legal: true, critical: true, note: 'Dans les 90 jours après achèvement — sinon perte exonération taxe foncière 2 ans.', links: [{ label: 'Cerfa 10867 (H1)', url: 'https://www.impots.gouv.fr/formulaire/6650/declaration-modele-h1' }, { label: 'Infos exonération TF', url: 'https://www.service-public.fr/particuliers/vosdroits/F59' }] },
