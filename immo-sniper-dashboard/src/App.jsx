  ...
  return (
    <div className="si">
      ...
      <div style={{display:"flex",gap:"8px",marginBottom:"14px",flexWrap:"wrap",alignItems:"center"}}>
        ...
        <a href="https://www.encheres-publiques.com/ventes-judiciaires/immobilier/bouches-du-rhone-13" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(255,59,59,0.1)",color:"#ff5555",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(255,59,59,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>ENCHÈRES JUDICIAIRES ↗</a>
        <a href="https://www.immobilier.notaires.fr/fr/ventes-aux-encheres?typeVente=NOTARIALE&departement=13" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(255,107,53,0.1)",color:"#ff6b35",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(255,107,53,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>ENCHÈRES NOTARIALES ↗</a>
        <a href="https://www.licitor.com/ventes-aux-encheres-immobilieres.html?dep=13" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(167,139,250,0.1)",color:"#a78bfa",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(167,139,250,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>LICITOR ↗</a>
      </div>
