  ...
  return (
    <div className="si">
      ...
      <div style={{display:"flex",gap:"8px",marginBottom:"10px",flexWrap:"wrap",alignItems:"center"}}>
        <a href={SCANNER_ENCHERES_URL} target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"6px",background:"linear-gradient(135deg,rgba(0,150,255,0.15),rgba(0,200,100,0.1))",color:"#00ff88",padding:"8px 18px",borderRadius:"3px",fontSize:"11px",textDecoration:"none",border:"1px solid rgba(0,255,136,0.3)",fontFamily:"inherit",letterSpacing:"0.06em",fontWeight:"600"}}>SCANNER ENCHÈRES 13 — TEMPS RÉEL ↗</a>
        <a href="https://encheresimmobilieres.fr/biens-en-vente?departement=13" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(255,59,59,0.1)",color:"#ff5555",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(255,59,59,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>TJ MARSEILLE / AIX (33 biens) ↗</a>
        <a href="https://www.licitor.com/ventes-aux-encheres-immobilieres.html?dep=13" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(255,107,53,0.1)",color:"#ff6b35",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(255,107,53,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>LICITOR (31 annonces) ↗</a>
        <a href="https://www.immobilier.notaires.fr/fr/annonces-immobilieres/immo-interactif/appartement/bouches-du-rhone-13" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(167,139,250,0.1)",color:"#a78bfa",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(167,139,250,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>NOTAIRES IMMO-INTERACTIF ↗</a>
      </div>
      <div style={{display:"flex",gap:"8px",marginBottom:"14px",flexWrap:"wrap",alignItems:"center"}}>
        <span style={{color:"#2a5070",fontSize:"9px",letterSpacing:"0.1em"}}>COLLECTIVITÉS</span>
        <a href="https://departement13.fr/les-ventes-immobilieres" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(96,184,255,0.1)",color:"#60b8ff",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(96,184,255,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>CD13 — VENTES DÉPARTEMENT ↗</a>
        <a href="https://cessions.immobilier-etat.gouv.fr/" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(96,184,255,0.1)",color:"#60b8ff",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(96,184,255,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>FRANCE DOMAINE — CESSIONS ÉTAT ↗</a>
        <a href="https://encheres-domaine.gouv.fr/" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(96,184,255,0.1)",color:"#60b8ff",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(96,184,255,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>DNID — ENCHÈRES DOMAINE ↗</a>
        <a href="https://www.agorastore.fr/ventes-occasions/immobilier" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(96,184,255,0.1)",color:"#60b8ff",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(96,184,255,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>AGORASTORE — COLLECTIVITÉS ↗</a>
        <a href="https://www.vench.fr/ventes-aux-encheres-par-departement-Bouches-du-Rh%C3%B4ne.html" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(96,184,255,0.1)",color:"#60b8ff",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(96,184,255,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>VENCH — 33 VENTES BDR ↗</a>
        <a href="https://www.interencheres.com/" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"5px",background:"rgba(96,184,255,0.1)",color:"#60b8ff",padding:"6px 14px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(96,184,255,0.2)",fontFamily:"inherit",letterSpacing:"0.06em"}}>INTERENCHÈRES ↗</a>
      </div>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:"16px"}}>
                ...
                <div>
                  ...
                  <div style={{display:"flex",gap:"6px",marginTop:"10px"}}>
                    <a href={SCANNER_ENCHERES_URL} target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"4px",background:"rgba(0,255,136,0.1)",color:"#00ff88",padding:"5px 12px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(0,255,136,0.25)",fontFamily:"inherit",letterSpacing:"0.05em",fontWeight:"600"}}>SCANNER ENCHÈRES 13 ↗</a>
                    {e.type==="JUDICIAIRE" && <a href="https://www.encheres-publiques.com/ventes-judiciaires/immobilier/bouches-du-rhone-13" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"4px",background:"rgba(255,59,59,0.1)",color:"#ff5555",padding:"5px 12px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(255,59,59,0.2)",fontFamily:"inherit",letterSpacing:"0.05em"}}>ENCHÈRES PUBLIQUES ↗</a>}
                    {e.type==="NOTARIALE" && <a href="https://www.immobilier.notaires.fr/fr/ventes-aux-encheres?typeVente=NOTARIALE&departement=13" target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"4px",background:"rgba(255,107,53,0.1)",color:"#ff6b35",padding:"5px 12px",borderRadius:"3px",fontSize:"10px",textDecoration:"none",border:"1px solid rgba(255,107,53,0.2)",fontFamily:"inherit",letterSpacing:"0.05em"}}>NOTAIRES.FR ↗</a>}
                  </div>
                </div>
              </div>
            </div>
